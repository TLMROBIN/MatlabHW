...
F_m2 = subs(F_m2,R,R0);
F_m2 = subs(F_m1,delta_m1,deltam_1);
F_m2 = subs(F_m1,delta_m2,deltam_2);
F_m2 = subs(F_m1,delta_R,deltaR);

F_R= subs(F_R,m1,m_1);
F_R= subs(F_R,m2,m_2);
F_R= subs(F_R,R,R0);
F_R = subs(F_m1,delta_m1,deltam_1);
F_R = subs(F_m1,delta_m2,deltam_2);
F_R = subs(F_m1,delta_R,deltaR);
